...
bar1 <- ggplot(tot_pages, aes(x = year, y = total)) +
  ...
  scale_x_continuous(breaks = xbreaks(tot_pages, 1, 19), 
...
# save bar2 as pdf
ggsave(here("charts", "output", "federal_register_pages_by_calendar_year_19.pdf"), plot = bar2, width = 12, height = 9, dpi = 300)
```
