...
# point to dataset
data_file = "regulatory_agency_personnel_by_fy.csv"
...
fig2_plot <- ggplot(fig2_long, aes(x = year, y = value, fill = category)) +
  ...
  ggtitle("Regulatory Agency Personnel by Fiscal Year") + # FOR REGULATORS' BUDGET REPORT add "Figure 2:" at the beginning, FOR REGSTATS PAGE remove "Figure 2:" from the beginning 
...
image_name = "regulatory_agency_personnel_by_fy"
