...
fig2_plot <- ggplot(fig2_long, aes(x = year, y = value, fill = category)) +
  ...
  ggtitle("Figure 2: Regulatory Agency Personnel by Fiscal Year") + # FOR REGULATORS' BUDGET add "Figure 2:" at the beginning, FOR REGSTATS remove "Figure 2:" from the beginning 
