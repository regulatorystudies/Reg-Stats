...
line1 <- ggplot(cum_sig_long, aes(x = months_in_office, y = econ_rules, color = president, group = president)) +
  ...
  ylab("Economically Significant Rules Published \n\n") +
  ...
  scale_y_continuous(breaks = seq(0, max(cun_sig_first_long$econ_rules) + 25, by = 25),
                     expand = c(0, 0),
                     limits = c(0, max(cun_sig_first_long$econ_rules) + 25)) +
  scale_x_continuous(breaks = seq(0, max(cun_sig_first_long$months_in_office)+4, by = 4),
                     expand = c(0, 0),
                     limits = c(0, max(cun_sig_first_long$months_in_office)+4))
