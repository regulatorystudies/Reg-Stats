...
monthly_sig1$Year <- as.character(monthl# manually set desired presidential admin (e.g. "Biden", "Trump 47", etc.)
...
monthly_sig3 <- monthly_sig2[monthly_sig2$Admin == Presidential.Admin, ]y_sig1$Year)
