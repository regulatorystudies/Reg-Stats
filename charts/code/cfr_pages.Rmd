...
# create caption text
caption_text <- paste("Sources: GovInfo.gov for the years 2024 and onwards; Federal Register Statistics for all the prior years. \n\nUpdated:", current_date)
...
bar2 <-
  ...
  geom_bar(stat="identity", fill="#033C5A", width = 0.8)+
  ...
  theme(
      ...
      axis.title.x = element_text(size = 12, angle = 0, vjust = 0.5, hjust = 0.5, margin = margin(t = 0)),
...
suppressWarnings({new_bar <- ggdraw() +
      draw_plot(bar2) +
      draw_image(logo, x = 0.1, y = 0.062, halign = 0, valign = 0, width = 0.2)
