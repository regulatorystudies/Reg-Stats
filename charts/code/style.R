...
# custom theme for RSC RegStats plots
  theme_RSC <- theme_minimal(base_family = "avenir_lt_pro") +
    theme(
      ...
      axis.title.x = element_text(size = 12, angle = 0, vjust = 0.5, hjust = 0.5, margin = margin(t = 12)),
      axis.ticks.x = element_line(color = RSCgray),
      axis.text.y = element_text(size = 12),
      axis.title.y = element_text(size = 12, angle = 90, vjust = 0.5, hjust = 0.5, margin = margin(r = 12)),
