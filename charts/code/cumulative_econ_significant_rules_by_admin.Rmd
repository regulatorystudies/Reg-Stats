...
# save line1 as pdf
<<<<<<< Updated upstream
ggsave(here("output", "cumulative_econ_significant_rules_by_presidential_month.pdf"), plot = line1, width = 12, height = 9, dpi = 300)
=======
ggsave(here("charts/output", "Cumulative Economically Significant Final Rules by Administration.pdf"), plot = line1, width = 12, height = 9, dpi = 300)
>>>>>>> Stashed changes
```
