...
bar1 <-
  ...
  ggtitle("Final Major Rules Published by Presidential Year") +
  ...
  theme_minimal() +
  theme(
      plot.title = element_text(hjust = 0.5, margin = margin(b = 20, unit = "pt"), size = 20),
...
new_bar <- ggdraw() +
      ...
      #draw_image(logo, x = 0.1, y = 0.03, halign = 0, valign = 0, width = 0.2)
       draw_image(logo,x = 0.1, y = 0.025, halign = 0, valign = 0, width = 0.2)
