...
#test <- filter_partial_year(num_fr, presidential_year)
today <- Sys.Date()
this_year <- year(today)
presidential_year_cutoff <- paste0(year(Sys.Date()), "-", "02-01")
if (today >= presidential_year_cutoff) {
  num_fr <- num_fr %>% filter(num_fr$presidential_year != this_year)
  } else {
  num_fr <- num_fr %>% filter(num_fr$presidential_year != (this_year - 1))
  }
