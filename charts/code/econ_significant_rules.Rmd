...
bar1 <- ggplot(econ_sig_rules, aes(x = year, y = rules, fill = party, pattern = party)) +
  ...
  theme_RSC +
  coord_cartesian(ylim = c(0, max(econ_sig_rules$rules) + 25)) +
  theme(
...
# save bar2 as pdf
ggsave(here("charts", "output", "econ_significant_final_rules_published_by_presidential_year.pdf"), plot = bar2, width = 12, height = 9, dpi = 300)
```
