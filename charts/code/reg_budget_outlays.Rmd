...
fig1_plot <- ggplot(fig1_long, aes(x = year, y = value, fill = category)) +
  ...
  ggtitle("Regulatory Agency Budget Outlays by Fiscal Year") + # FOR REGULATORS' BUDGET REPORT add "Figure 1:" at the beginning, FOR REGSTATS remove "Figure 1:" from the beginning 
