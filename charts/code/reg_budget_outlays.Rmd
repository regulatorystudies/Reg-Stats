...
fig1_plot <- ggplot(fig1_long, aes(x = year, y = value, fill = category)) +
  ...
  ggtitle("Figure 1") + # SET TO "Figure 1" for Regulators' Budget report; SET TO "Regulatory Agency Budget Outlays by Fiscal Year" for RegStats chart
  ...
  labs(fill = NULL, 
       ...
       subtitle = "Regulatory Agency Budget Outlays by Fiscal Year") + # SET TO "Regulatory Agency Budget Outlays by Fiscal Year" for Regulators' Budget report; COMMENT OUT subtitle for RegStats chart
  scale_y_continuous(
