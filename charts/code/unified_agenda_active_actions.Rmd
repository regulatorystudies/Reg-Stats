...
# create year, Season, and sort columns [if a yearseason value just specifies the year but not the season (e.g. 2012), then Fall will be assigned as the season]
df1_1a <- df1_1 %>%
...
bar2 <- ggplot(df1_1a_complete,
  ...
  xlab("Note: Only the Fall Agenda is available for 1995 and only one agenda was published in 2012. \n") +
