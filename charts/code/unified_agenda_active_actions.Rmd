...
bar2 <- ggplot(df1_1a_complete,
  ...
  xlab("\nNote: Only the Fall Agenda is available for 1995, and only one Agenda was published in 2012, 2025, and 2026. Active actions refer to \nrulemakings in a pre-rule, proposed rule or final rule stage as indicated by the Unified Agenda.") +
