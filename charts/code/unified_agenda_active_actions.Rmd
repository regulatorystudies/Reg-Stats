...
data_new1$yearseason <- str_replace(data_new1$yearseason, "Spring", "S")
data_new1$yearseason <- str_replace(data_new1$yearseason, "Fall", "F")
```
...
#plot
bar2 <-
  ggplot(data=data_new1, aes(x=yearseason, y=Total), family = "avenir_lt_pro") +
