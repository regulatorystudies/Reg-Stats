...
static PyObject *impl_pkg_resources$$45$postLoad$$$function__1__has(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_14cf77dfe88f8a0bcc9c2b0dbe766dce = MAKE_FUNCTION_FRAME(tstate, codeobj_14cf77dfe88f8a0bcc9c2b0dbe766dce, module_pkg_resources$$45$postLoad, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_14cf77dfe88f8a0bcc9c2b0dbe766dce);
...
static PyObject *impl_pkg_resources$$45$postLoad$$$function__2__isdir(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_fe316ecab18153158bc1b2abe35b2a91)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_fe316ecab18153158bc1b2abe35b2a91 = MAKE_FUNCTION_FRAME(tstate, codeobj_fe316ecab18153158bc1b2abe35b2a91, module_pkg_resources$$45$postLoad, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_fe316ecab18153158bc1b2abe35b2a91);
...
static PyObject *impl_pkg_resources$$45$postLoad$$$function__3__listdir(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_60ec0b1ab8e46bcd003cf3b0188e806c)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_60ec0b1ab8e46bcd003cf3b0188e806c = MAKE_FUNCTION_FRAME(tstate, codeobj_60ec0b1ab8e46bcd003cf3b0188e806c, module_pkg_resources$$45$postLoad, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_60ec0b1ab8e46bcd003cf3b0188e806c);
...
static PyObject *impl_pkg_resources$$45$postLoad$$$function__4_get_resource_stream(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_04d0faa951fd9bb6766136033b5726c5)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_04d0faa951fd9bb6766136033b5726c5 = MAKE_FUNCTION_FRAME(tstate, codeobj_04d0faa951fd9bb6766136033b5726c5, module_pkg_resources$$45$postLoad, sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_04d0faa951fd9bb6766136033b5726c5);
...
static PyObject *impl_pkg_resources$$45$postLoad$$$function__5__get(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_39cad1035452263b5646bba5511dc7cb)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_39cad1035452263b5646bba5511dc7cb = MAKE_FUNCTION_FRAME(tstate, codeobj_39cad1035452263b5646bba5511dc7cb, module_pkg_resources$$45$postLoad, sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_39cad1035452263b5646bba5511dc7cb);
...
// Mark the execution in the "__spec__" value.
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_1088c9f9fa0c46ed287ae3dd93e81a1f);
    ...
    branch_end_1:;
    {
        ...
        frame_b67b4734ef157f5e1827443fff91dcab_2 = MAKE_CLASS_FRAME(tstate, codeobj_b67b4734ef157f5e1827443fff91dcab, module_pkg_resources$$45$postLoad, NULL, sizeof(void *));

        // Push the new frame as the currently active one, and we should be exclusively
        // owning it.
        pushFrameStackCompiledFrame(tstate, frame_b67b4734ef157f5e1827443fff91dcab_2);
