...
static void createModuleConstants(PyThreadState *tstate) {
    if (constants_created == false) {
        loadConstantsBlob(tstate, &mod_consts[0], UNTRANSLATE("urllib3.packages.backports.makefile"));
...
#ifndef __NUITKA_NO_ASSERT__
void checkModuleConstants_urllib3$packages$backports$makefile(PyThreadState *tstate) {
...
static void createModuleCodeObjects(void) {
    ...
    codeobj_ec1fbde94b58da14f7826c901946514f = MAKE_CODE_OBJECT(module_filename_obj, 1, 0, mod_consts[32], mod_consts[32], NULL, NULL, 0, 0, 0);
    codeobj_4395a0b60848ca5c19927c4d469ae66f = MAKE_CODE_OBJECT(module_filename_obj, 13, CO_OPTIMIZED | CO_NEWLOCALS, mod_consts[30], mod_consts[30], mod_consts[33], NULL, 6, 0, 0);
}
...
static PyObject *impl_urllib3$packages$backports$makefile$$$function__1_backport_makefile(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_4395a0b60848ca5c19927c4d469ae66f);
...
static function_impl_code const function_table_urllib3$packages$backports$makefile[] = {
    impl_urllib3$packages$backports$makefile$$$function__1_backport_makefile,
    NULL
};
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    int offset = Nuitka_Function_GetFunctionCodeIndex(function, function_table_urllib3$packages$backports$makefile);
...
static PyObject *_create_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    return (PyObject *)Nuitka_Function_CreateFunctionViaCodeIndex(
        ...
        kw_defaults,
        doc,
        function_table_urllib3$packages$backports$makefile,
        sizeof(function_table_urllib3$packages$backports$makefile) / sizeof(function_impl_code)
    );
}
...
PyObject *modulecode_urllib3$packages$backports$makefile(PyThreadState *tstate, PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *loader_entry) {
    // Report entry to PGO.
    ...
    if (init_done == false) {
        ...
        NUITKA_PRINT_TRACE("urllib3$packages$backports$makefile: Calling createModuleConstants().\n");
        createModuleConstants(tstate);
...
#if defined(_NUITKA_MODULE) && 0
    PyObject *pre_load = IMPORT_EMBEDDED_MODULE(tstate, "urllib3.packages.backports.makefile" "-preLoad");
    if (pre_load == NULL) {
        return NULL;
    }
#endif
...
// Set the "__spec__" value
    ...
    // Other modules get a "ModuleSpec" from the standard mechanism.
    {
        ...
        PyObject *spec_value = CALL_FUNCTION_WITH_SINGLE_ARG(tstate, _spec_from_module, module_urllib3$packages$backports$makefile);
...
// Mark the execution in the "__spec__" value.
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_ec1fbde94b58da14f7826c901946514f);
