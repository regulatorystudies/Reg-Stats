...
static PyCodeObject *codeobj_2af7039f763a5dc085fc2dbce770c477;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(mod_consts[20]); CHECK_OBJECT(module_filename_obj);
    codeobj_2af7039f763a5dc085fc2dbce770c477 = MAKE_CODE_OBJECT(module_filename_obj, 1, 0, mod_consts[21], mod_consts[21], NULL, NULL, 0, 0, 0);
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_2af7039f763a5dc085fc2dbce770c477;
    ...
    frame_2af7039f763a5dc085fc2dbce770c477 = MAKE_MODULE_FRAME(codeobj_2af7039f763a5dc085fc2dbce770c477, module_cryptography$hazmat$primitives$asymmetric);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_2af7039f763a5dc085fc2dbce770c477);
    assert(Py_REFCNT(frame_2af7039f763a5dc085fc2dbce770c477) == 2);
    ...
    // Framed code:
    {
        ...
        frame_2af7039f763a5dc085fc2dbce770c477->m_frame.f_lineno = 1;
        {
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_2af7039f763a5dc085fc2dbce770c477, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_2af7039f763a5dc085fc2dbce770c477->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_2af7039f763a5dc085fc2dbce770c477, exception_lineno);
    }



    assertFrameObject(frame_2af7039f763a5dc085fc2dbce770c477);
