...
*Note: Significance classifications in the first one to two years of the `fr_tracking.csv` dataset may not be fully accurate, as the policy team was establishing classification practices during that period.*
