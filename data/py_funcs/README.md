...
## frcount.py
This script contains functions that generate annual and monthly counts of significant, economically/3(f)(1) significant, and major rules from the 'fr_tracking.csv' dataset.
## party.py
