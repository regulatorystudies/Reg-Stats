...
*Note: Due to EO 14215, independent regulatory agencies are now subject to OIRA review for all types of significant rules as defined under EO 12866 (including economically significant rules). In the coming years, we should consider including these previously unaccounted for agencies in the ES rules by agency scraper and visualization script.*
