...
here::i_am("code/regstats_graph_demo.Rmd")
```
...
```{r load data}
# load csv using here
cum_sig <- read.csv(here("data", "Cumulative_ES_rules_published_months_in_office_071023.csv"), skip = 1)
...
```{r save to output}
# save line1 as pdf
ggsave(here("output", "cum_ES_rules.pdf"), plot = line1, width = 12, height = 9, dpi = 300)
```
